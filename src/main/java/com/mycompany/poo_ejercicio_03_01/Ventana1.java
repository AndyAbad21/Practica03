...
public class Ventana1 extends JFrame
{
    ...
    public void crearJPanel()
    {
        ...
        this.jPanel.add(jLabelList.get(3),BorderLayout.SOUTH);
        this.jPanel.add(jLabelList.get(2),BorderLayout.EAST);
        this.jPanel.add(jLabelList.get(4),BorderLayout.WEST);
        this.jPanel.add(jLabelList.get(1),BorderLayout.CENTER);
    }
